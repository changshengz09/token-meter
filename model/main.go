...
` + "`original_price_amount`" + ` decimal(10,6) NOT NULL DEFAULT 0,
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "title_i18n", DDL: "`title_i18n` text"},
		{Name: "subtitle_i18n", DDL: "`subtitle_i18n` text"},
		{Name: "price_amount", DDL: "`price_amount` decimal(10,6) NOT NULL"},
		{Name: "original_price_amount", DDL: "`original_price_amount` decimal(10,6) NOT NULL DEFAULT 0"},
